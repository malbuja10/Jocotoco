...
| `deploy/raspberry/` | Cliente del dispositivo en bash (step-cli + curl + systemd) |
| `deploy/raspberry/python/` | Cliente equivalente en Python, para integrarlo en un programa propio |
